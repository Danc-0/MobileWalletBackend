...
import com.comulynx.wallet.rest.api.mobilewalletspringbootapi.model.Transaction;
import com.comulynx.wallet.rest.api.mobilewalletspringbootapi.repository.AccountRepository;
import com.comulynx.wallet.rest.api.mobilewalletspringbootapi.repository.TransactionRepository;
...
public class TransactionController {
	...
	public ResponseEntity<?> getLast100TransactionsByCustomerId(@RequestBody String request)
		...
		try {
			...
			List<Transaction> last100Transactions = transactionRepository.findTransactionsByCustomerId(customerId).orElse(null);
